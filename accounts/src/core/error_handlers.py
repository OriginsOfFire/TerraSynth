...
from src.core.exception.base_exception import WrongCredentialsError, InvalidTokenError, ObjectNotFoundError


@app.exception_handler(WrongCredentialsError)
async def wrong_credentials_error_handler(request: Request, exception: WrongCredentialsError) -> JSONResponse:
    return JSONResponse(
